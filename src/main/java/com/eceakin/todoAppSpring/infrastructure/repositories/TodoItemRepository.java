...
public interface TodoItemRepository extends JpaRepository<TodoItem, Long> {
	...
	@Query("SELECT ti FROM TodoItem ti WHERE ti.dueDate IS NOT NULL AND ti.dueDate <= :date AND ti.completed = false")
	List<TodoItem> findOverdueTodoItems(@Param("date") LocalDate date);
